	...
	public static void main(String[] args) {
		...
		Scanner sc=new Scanner(System.in);
			...
			for(int i=0;i<t;i++)
			{
				...
				for(String si:words)
				{
					if(si.contains("mon")||si.contains("tue")||si.contains("wed")||si.contains("thu")||si.contains("fri"))
						week++;
					if(si.contains("sat")||si.contains("sun"))
						weekend++;
						
				}
				if(words[i].contains("Regular"))
					str="Regular";
				else
					str="Rewards";
				function1(str,week,weekend);
				}
